...
public class ACT_Login extends AppCompatActivity {
    private static String TAG = "ACT_Login";
    ...
    public void clickRegisterLayout(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            startActivityForResult(new Intent(this, ACT_Register.class), StaticConfig.REQUEST_CODE_REGISTER, options.toBundle());
        } else {
            startActivityForResult(new Intent(this, ACT_Register.class), StaticConfig.REQUEST_CODE_REGISTER);
        }
    }
    ...
    class AuthUtils {
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(ACT_Login.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            // If sign in fails, display a MDLMessage to the user. If sign in succeeds
                            // the auth state listener will be notified and logic to handle the
                            // signed in user can be handled in the listener.
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(ACT_Login.this) {
                                    @Override
                                ...
                                initNewUserInfo();
                                Toast.makeText(ACT_Login.this, "Register and Login success", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(ACT_Login.this, ACT_Home.class));
                                ACT_Login.this.finish();
                            }
                        }
        ...
        void saveUserInfo() {
            FirebaseDatabase.getInstance().getReference().child("user/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    MDL_User MDLUserInfo = new MDL_User();
                    MDLUserInfo.name = (String) hashUser.get("name");
                    MDLUserInfo.email = (String) hashUser.get("email");
                    MDLUserInfo.avata = (String) hashUser.get("avata");
                    SharedPreferenceHelper.getInstance(ACT_Login.this).saveUserInfo(MDLUserInfo);
                }
        ...
        void initNewUserInfo() {
            MDL_User newMDLUser = new MDL_User();
            newMDLUser.email = user.getEmail();
            newMDLUser.name = user.getEmail().substring(0, user.getEmail().indexOf("@"));
            newMDLUser.avata = StaticConfig.STR_DEFAULT_BASE64;
            FirebaseDatabase.getInstance().getReference().child("user/" + user.getUid()).setValue(newMDLUser);
        }
    }
}
